...
// Birinchi rasmni (uchta butilka) src/assets/bottles.png nomi bilan qo'shing va quyidagi qatorni faollashtiring:
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-cream p-8 rounded-lg shadow-lg text-center">
              <div className="w-48 h-64 bg-gold/20 rounded-lg mx-auto mb-4 flex items-center justify-center overflow-hidden">
                {/* Birinchi rasmni (uchta butilka) qo'shgandan keyin quyidagi qatorni o'zgartiring: */}
                <img src={probnik} alt="HIDIM Parfum Butilkalari" className="max-w-full max-h-full object-contain" />
                {/* <img src={bottles} alt="HIDIM Parfum Butilkalari" className="max-w-full max-h-full object-contain" /> */}
              </div>
